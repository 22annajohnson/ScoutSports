...
Read these documents in order when preparing database work: database overview, Supabase operating model, migration workflow, RLS expectations, storage planning, approved/proposed implementation plan, then Jira ticket.
