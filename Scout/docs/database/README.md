...
Read these documents in order when preparing database work: database overview, Supabase operating model, migration workflow, RLS expectations, secrets and GitHub integration, approved/proposed implementation plan, then Jira ticket.
