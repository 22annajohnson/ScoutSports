...
Read these documents in order when preparing database work: database overview, Supabase operating model, migration workflow, RLS expectations, Edge Function planning, generated type workflow, approved/proposed implementation plan, then Jira ticket.
